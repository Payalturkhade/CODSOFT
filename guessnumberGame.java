...
j.setBackground(c0l0r.black);
j.setFont(new Font("tunga",Font.BOLD,50));
j.setSize(370,200);
j.setLocation(300,100);
//Creating label Enter a number.....
JLabel j1=new JLabel("Enter Your Guess b/w 1-100");
j1.setFont(new Font("tunga",Font.BOLD,37));
j1.setSize(290,30);
j1.setLocation(310,90);
//Creating TextField for input guess
t1=new JTextField(10);
t1.setSize(60,40);
 t1.setLocation(450,300);
